...
def classify_api_error(
    ...
    *,
    ...
    # prior assistant turn was stripped/altered before replay — usually
    # caused by upstream context compression or an over-aggressive adapter).
    # Don't gate on provider — OpenRouter proxies Anthropic errors, so the
    # provider may be "openrouter" even though the error is Anthropic-specific.
    # The message pattern is unique enough. (Mirrors PR #24107.)
    if (
        status_code == 400
